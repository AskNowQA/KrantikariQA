...
def main():
    ...
    vectors, questions, pos_paths, neg_paths = load_data("training-rdf-data-v3.pickle", max_length)
    ...
    # ])
        ...
        print "Precision (hits@1) = ", rank_precision(model, test_questions, test_pos_paths, test_neg_paths, 270, 10000)
