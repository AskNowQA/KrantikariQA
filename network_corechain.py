...
def parikh(_gpu, vectors, questions, pos_paths, neg_paths, _neg_paths_per_epoch_train = 10, _neg_paths_per_epoch_test = 1000):
    ...
    with K.tf.device('/gpu:' + gpu):
        ...
        dense = n._simpleDense(max_length,nr_hidden/2)
        encode_step_2 = n._simple_BiRNNEncoding(max_length, embedding_dims, nr_hidden, 0.5)
        ...
        def getScore(ques, path):
            ...
            dense_ques = dense(feats_ques)
            dense_path = dense(feats_path)
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            assert model.lower() in ['birnn_dot', 'parikh', 'birnn_dense', 'maheshwari', 'birnn_dense_sigmoid','cnn']
            break
